...
public class TourServiceUI {
    ...
    public static final String TOUR_SERVICE_ITEM = "//div[contains(@data-bind,'tourService')]/div[i]//label";
    public static final String TOUR_SERVICE_LIST = "//div[contains(@data-bind,'tourService')]";
    public static final String HALO_SERVICE_ITEM = "//div[contains(@data-bind,'haloService')]/div[i]//label";

...
public class MediaManagementUI {
    ...
    public static final String ROOT_IMAGE = "//div[contains(@data-bind,'onCreateAlbum')]/ancestor::div[@id ='media-album-area']/following-sibling::div//div[@class='media-list']/div[@class = 'media-list__item'][position()= '%s']";

...
public class HeaderPageUI {
    ...
    public static final String HELPER_ICON = "//i[contains(@class,'ic-chat-primary')]";
    public static final String NOTIFICATION_ICON = "//i[contains(@class,'ic-chat-primary')]";
    public static final String SETTING_ICON = "//i[contains(@class,'ic-chat-primary')]";

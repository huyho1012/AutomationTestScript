...
public class BusinessPageManagementUI {
    ...
    public static final String ID_OF_PAGE_NAME = "//span[contains(@data-bind,' pageVM().pv101')][contains(text(),'hahaha')]/parent::h5/following-sibling::div//span[contains(@data-bind,'pageVM().id')]";
}

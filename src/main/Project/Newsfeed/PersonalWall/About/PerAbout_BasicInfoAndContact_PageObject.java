...
public class PerAbout_BasicInfoAndContact_PageObject extends PersonalCommon {
    ...
    public void clickToAddnewOtherPhone(){
        ...
        clickToElement(driver, PerAbout_ContactAndBasicInfo_PageUI.BUTTON_ADD_OTHER_PHONE);
    }
    ...
    public String getEmailAddressDisplay(){
        waitElementToVisible(driver, PerAbout_ContactAndBasicInfo_PageUI.CONTACT_AND_BASIC_INFO_TAB);
        waitElementToVisible(driver, PerAbout_ContactAndBasicInfo_PageUI.EMAIL_DATA);
        return getTextElement(driver, PerAbout_ContactAndBasicInfo_PageUI.EMAIL_DATA);
    }

    // Hàm thêm Email
    public void clickToButtonAddNewEmail(){
        waitForElementClickable(driver, PerAbout_ContactAndBasicInfo_PageUI.BUTTON_ADD_EMAIL);
        clickToElement(driver, PerAbout_ContactAndBasicInfo_PageUI.BUTTON_ADD_EMAIL);
    }

    // Hàm nhập dữ liệu Email
    public void enterDataToEmailField(String email){
        waitElementToVisible(driver, PerAbout_ContactAndBasicInfo_PageUI.EMAIL_FIELD);
        sendKeyToElement(driver, PerAbout_ContactAndBasicInfo_PageUI.EMAIL_FIELD, email);
    }

    // Hàm lấy thông báo lỗi của ô Email
    public String getErrorMessageOfEmailField(){
        waitElementToVisible(driver, PerAbout_ContactAndBasicInfo_PageUI.EMAIL_ERROR_MESSAGE);
        return getTextElement(driver, PerAbout_ContactAndBasicInfo_PageUI.EMAIL_ERROR_MESSAGE);
    }

    // Hàm đồng ý cập nhật / Thêm mới email
    public void clickToUpdateEmail(){
        waitForElementClickable(driver, PerAbout_ContactAndBasicInfo_PageUI.BUTTON_SAVE_EMAIL);
        clickToElement(driver, PerAbout_ContactAndBasicInfo_PageUI.BUTTON_SAVE_EMAIL);
    }

    // Hàm huỷ cập nhật/ Thêm mới email
    public void clickToCancelUpdateEmail(){
        waitForElementClickable(driver, PerAbout_ContactAndBasicInfo_PageUI.BUTTON_CANCEL_SAVE_EMAIL);
        clickToElement(driver, PerAbout_ContactAndBasicInfo_PageUI.BUTTON_CANCEL_SAVE_EMAIL);
    }
